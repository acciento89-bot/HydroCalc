# HydroCalc — App Store metadata

## Identifiers

- App name: HydroCalc
- Bundle ID: `de.kamilunavo.hydrocalc`
- Version: `1.0.0`
- Build: `1`
- Category: Utilities
- Pro product: `de.kamilunavo.hydrocalc.pro`
...
### Keywords
HVAC,hydronic,flow,deltaT,pipe,velocity,Kv,pressure,heating,technician

## URLs

- Support URL: `https://kamilunavo.com/support`
- Privacy Policy URL: `https://kamilunavo.com/hydrocalc/privacy`

## App privacy

No account, no ads, no analytics, no tracking and no Kamilunavo backend for calculation data. Calculation inputs remain on device. StoreKit is used only for the optional one-time Pro purchase and restore flow.
